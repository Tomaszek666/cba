<?php require_once "../controller/controller.php";require_once "../controller/funkcje_zdjecia.php";
    ...
    $obrobka_zdjecia->wyswietlanie_jednego_zdjecia_uzytkownika(679487497);
    if(isset($_SESSION["prawid_uzyt"])){
    $formularze->wyswietl_form_forum(679487497);}
    ...
    $pobieranie_akcji->dodawanie_komentarza_do_zdjecia(679487497,$tekst,$_SESSION["prawid_uzyt"]);};
    ...
    if(isset($_GET["akcja"])){
                  switch($_GET["akcja"]){
                    ...
                    case "odejmowanie_pop_komentarza":
                      ...
                      $formularze->wyswietl_odpowiedz_form_forum($_GET["id"],679487497);
                      break;
                      ...
                      $pobieranie_akcji->dodawanie_komentarzy_do_odpowiedzi_poszczegolnych_uzytkownikow_zdjecia($_GET["nr_id"],679487497,$tekst_odp,$_SESSION["prawid_uzyt"]);
                      };
                      break;
                  }  
    };
    $pobieranie_akcji->wyswietlanie_komentarzy_do_zdjecia(679487497);
