...
class view{
    ...
    ?>
     ...
     <table>
       <tr>
         <td>Preferowana nazwa uzytkownika <br />(maksymalnie 10 znakow):</td>
         <td valign="top"><input type="text" name="nazwa_uz"
                         size="16" maxlength="10"/></td></tr>
       <tr>
         <td>Haslo <br />(pomiedzy 6 i 10 znakow):</td>
         <td valign="top"><input type="password" name="haslo"
                         size="16" maxlength="10"/></td></tr>
       <tr>
         <td>Potwierdz haslo:</td>
         <td><input type="password" name="haslo2" size="16" maxlength="10"/></td></tr>
       <tr>
         <td colspan="2" align="center">
